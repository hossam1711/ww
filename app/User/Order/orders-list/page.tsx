// OrdersList page to display all order cards stacked on the left
"use client";

import React, { useState } from 'react';
import { motion } from 'framer-motion';
import { ArrowLeft, Search, Plus, Package, Clock, CheckCircle, Settings } from 'lucide-react';
import { PageContainer } from '../../components/PageContainerProps';
...
export default function OrdersListPage() {
  ...
  const handleViewDetails = (orderId: string) => {
    ...
    // Here you can navigate to order details page or show a modal
  ...
  return (
    <PageContainer showSidebar={true}>
      <div className="p-6">
        ...
        {/* Stacked Orders List - All on the left */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
