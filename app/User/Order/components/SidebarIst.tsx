    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-4 mt-2 relative">
          ...
          {/* New Order Button with Event Icon */}
          <motion.button
            onClick={onNewOrder}
            className="relative group flex flex-col items-center"
            whileHover={{ scale: 1.05 }}
          ...
          >
            ...
            {/* Event Icon */}
            <motion.div
              className="absolute -top-3 right-0 w-6 h-6 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center shadow-lg"
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              exit={{ scale: 0 }}
              transition={{ duration: 0.1 }}
