...
export default function PaymentSummary({ selectedServices, totalAmount, onPayNow }: PaymentSummaryProps) {
  return (
    <div className="w-96 sticky top-8 h-fit z-10">
      <motion.div
        initial={{ opacity: 0, x: 20 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ delay: 0.3 }}
        className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 shadow-xl"
      >
